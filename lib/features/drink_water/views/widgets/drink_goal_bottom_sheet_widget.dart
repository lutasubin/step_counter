...
/// Widget bottom sheet cho drinking goal
class DrinkGoalBottomSheetWidget extends StatelessWidget {
  final DrinkWaterSettingsController controller;

  const DrinkGoalBottomSheetWidget({super.key, required this.controller});
  ...
  Widget _buildOptionsList(BuildContext context) {
    return Flexible(
      child: ListView.separated(
        ...
        itemCount: controller.goalOptions.length,
        ...
        itemBuilder: (context, index) {
          final value = controller.goalOptions[index];
          return Obx(
            () => InkWell(
              onTap: () {
                controller.updateDrinkingGoal(value);
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CustomRadioButtonWidget(
                      isSelected: controller.drinkingGoal == value,
                      onTap: () {
                        controller.updateDrinkingGoal(value);
                        Navigator.pop(context);
                      },
